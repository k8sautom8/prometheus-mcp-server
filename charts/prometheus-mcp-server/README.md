...
| `containerPort` | Container port | `8052` |
...
| `service.port` | Service port | `8052` |
...
```bash
kubectl port-forward svc/prometheus-mcp-server 8052:8052
```

The MCP endpoint will be available at `http://127.0.0.1:8052/sse`.
